...
(function () {
    ...
    function core() { return remote(PUBLISH_BASE + 'apps/missav/missav_core.js?v=' + MODULE_VERSION, CORE_PATH); }
    function pages() { return remote(PUBLISH_BASE + 'apps/missav/missav_pages.js?v=' + MODULE_VERSION, PAGES_PATH); }
